@extends('main')
@section('title') Редактирование статуса @stop
@section('content')
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <form class="needs-validation" method="post"
                                action="{{ route('pages.statuses.update', ['status' => $statusId]) }}" novalidate>
                                @csrf
                                @method('put')
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" class="form-control" id="name" name="name"
                                                        placeholder="Название статуса.." value="{{ $statusId->name }}"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-xl-4 col-lg-6 mb-3">
                                                    <input type="text" class="as_colorpicker form-control" id="color"
                                                        name="color" placeholder="#000000" value="{{ $statusId->color }}"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
