            ...
            <div class="col-12">
                <div class="card">
                    <div id="btn-header" class="card-header">
                        ...
                        <a type="button" class="btn btn-primary btn-rounded" href="{{ route('pages.rules.create') }}">
                    ...
                    <div class="card-body">
                        ...
                        @include('pages.rules.deleteModal')
                        <div class="table-responsive">
                            <table id="example3" class="display table table-hover" style="min-width: 845px">
                                ...
                                <tbody>
                                    @forelse ($rulesList as $i)
                                        <tr style="height:63.38px;">
                                            <td>{{ $i->id }}</td>
                                            <td style="text-align: left;">{{ $i->name }}</td>
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('pages.rules.edit', ['rule' => $i->id]) }}"
