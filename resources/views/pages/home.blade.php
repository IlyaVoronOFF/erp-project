@extends('main')
@section('title') Главный экран @stop
@section('content')
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="progress mb-4" style="height:13px;">
                           <div class="progress-bar gradient-5 progress-animated" style="width: 55%; height:13px;"
                              role="progressbar">
                              <span class="sr-only">45% Complete</span>
                           </div>
                        </div>
                        <div class="progress mb-4" style="height:13px;">
                           <div class="progress-bar gradient-6 progress-animated" style="width: 70%; height:13px;"
                              role="progressbar">
                              <span class="sr-only">45% Complete</span>
                           </div>
                        </div>
                        <div class="progress default-progress" style="height:13px;">
                           <div class="progress-bar gradient-7 progress-animated" style="width: 50%; height:13px;"
                              role="progressbar">
                              <span class="sr-only">45% Complete</span>
                           </div>
                        </div>
                     ...
                     <div class="col-xl-6 col-sm-6">
                        <div class="dz-image-bx rounded">
                           <div class="dz-media active me-3">
                              <img class="rounded" src="{{asset('assets/images/user.png')}}" alt="">
                           </div>
                           <div class="dz-info">
                  ...
                  <div class="card">
                     ...
                     <div class="card-body customer-review-bx p-0 dz-scroll loadmore-content"
                        ...
                        <div class="dz-review-bx">
                           <img class="dz-media me-4" src="{{asset('assets/images/user.png')}}" alt="">
                           <div class="dz-info">
                              ...
                              <div class="dz-footer">
                                 <p class="text-black op8 mb-sm-0 mb-3 me-4">I have been there many times.Rooms
                                    ,Food and Service are excellent.we did lots of Excursions and all the places
                                    are from the Hotel reachable. we visited Long Waterfall and was very helpful
                                    and excellent</p>
                                 <a class="review-icon rounded-circle btn-success me-3" href="javascript:void(0);"><i
                                       class="far fa-check-circle"></i></a>
                                 <a class="review-icon rounded-circle btn-danger" href="javascript:void(0);"><i
                        ...
                        <div class="dz-review-bx">
                           ...
                           <div class="dz-info">
                              <div class="dz-name mb-3">
                                 <div>
                                    <h6 class="title mb-1">Ali Muzair</h6>
                                    <span class="date text-black op8">Posted o
                                       n 26/04/2020, 12:42 AM</span>
                                 </div>
                                 <ul class="star-review">
                                    <li><i class="fas fa-star orange"></i></li>
                                    <li><i class="fas fa-star orange"></i></li>
                     ...
                     <div class="card-footer style-1 border-0 pt-0 text-center">
                        <a href="javascript:void(0);" class="dz-load-more fas fa-chevron-down" id="customerReview"
                           rel="ajax/customer-review.html"></a>
                     </div>
                  </div>
               </div>
            </div>
