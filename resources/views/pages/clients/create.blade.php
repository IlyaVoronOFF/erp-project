@extends('main')
@section('title') Создание клиента @stop
@section('content')
         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="table-responsive">
                  <form class="needs-validation" method="post" action="{{route('pages.clients.store')}}" novalidate>
                     @csrf
                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                       placeholder="Наименование клиента.." value="{{old('name')}}" required>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-lg-9">
                                    <textarea class="form-control" id="address" name="address"
                                       placeholder="Адрес клиента.." value="{{old('address')}}"></textarea>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-lg-9">
                                    <textarea class="form-control" id="description" name="description"
                                       placeholder="Уточнения по клиенту.." value="{{old('description')}}" ></textarea>
                                 </div>
                              </div>
                           </div>
                        </div>
