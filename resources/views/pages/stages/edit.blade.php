@extends('main')
@section('title') Редактирование стадии @stop
@section('content')
         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="table-responsive">
                  <form class="needs-validation" method="post" action="{{route('pages.stages.update',['stage'=>$stageId])}}" novalidate>
                     @csrf
                     @method('put')
                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                       placeholder="Название стадии.." value="{{$stageId->name}}" required>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" class="form-control" id="short_name" name="short_name"
                                       placeholder="Сокращённое название...." value="{{$stageId->short_name}}" required>
                                 </div>
                              </div>
                           </div>
                        </div>
