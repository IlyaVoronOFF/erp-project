            ...
            <div class="col-12">
                <div class="card">
                    <div id="btn-header" class="card-header">
                        ...
                        <a type="button" class="btn btn-primary btn-rounded" href="{{ route('pages.stages.create') }}">
                    ...
                    <div class="card-body">
                        ...
                        @include('pages.stages.deleteModal')
                                ...
                                <tbody>
                                    @forelse ($stagesList as $i)
                                        <tr style="height:63.38px;">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{ route('pages.stages.edit', ['stage' => $i->id]) }}"
