@extends('main')
@section('title') Создание раздела @stop
@section('content')
         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="table-responsive">
                  <form class="needs-validation" method="post" action="{{route('pages.parts.store')}}" novalidate>
                     @csrf
                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                       placeholder="Название раздела.." value="{{old('name')}}" required>
                                 </div>
                              </div>
                           </div>
                        </div>
