      ...
      <div class="col-12">
         <div class="card">
            <div class="card-header">
               ...
               <a type="button" class="btn btn-primary btn-rounded" href="{{route('pages.parts.index')}}">
            ...
            <div class="card-body">
               <div class="table-responsive">
                  <form class="needs-validation" method="post" action="{{route('pages.parts.update',['part'=>$partId])}}" novalidate>
                     @csrf
                     @method('put')
                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                       placeholder="Название раздела.." value="{{$partId->name}}" required>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="mb-3 row">
                                 ...
                                 <div class="col-lg-9">
                                    <input type="text" class="form-control" id="short_name" name="short_name"
                                       placeholder="Сокращённое название...." value="{{$partId->short_name}}" required>
                                 </div>
                              </div>
                           </div>
                        </div>
