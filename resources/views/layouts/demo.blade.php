        ...
        <div class="nav-header">
            <a href="#" class="brand-logo">
                <img src="{{ asset('assets/images/logotip.png') }}" class="logo-img" width="50" height="50"
                    alt="logo">
                <span class="brand-title" width="123" height="68">NAME</span>
                                            ...
                                            <div class="dz-info">
                                                ...
                                                <div class="dz-footer">
                                                    <p class="text-black op8 mb-sm-0 mb-3 me-4">I have been there many
                                                        times.Rooms
                                                        ,Food and Service are excellent.we did lots of Excursions and
                                                        all the places
                                                        are from the Hotel reachable. we visited Long Waterfall and was
                                                        very helpful
                                                        and excellent</p>
