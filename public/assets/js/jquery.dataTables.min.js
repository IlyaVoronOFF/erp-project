...
(function(h) {
    ...
    function sb(a) {
        ...
        c || (a.aoDrawCallback.push({ fn: Cb, sName: "information" }), d.attr("role", "status").attr("aria-live", "polite"), h(a.nTable).attr("aria-describedby",
            b + "_info").wrap('<div class="big-table table-responsive"></div>'));
        return d[0]
    }
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "Первый", sLast: "Последний", sNext: "Вперёд", sPrevious: "Назад" },
            sEmptyTable: "Нет записей",
            sInfo: "Показано от _START_ до _END_ из _TOTAL_ строк",
            sInfoEmpty: "Показано 0 строк",
            sInfoFiltered: "(Отфильтровано из _MAX_ элементов)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
