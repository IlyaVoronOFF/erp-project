! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.moment = t() }(this, function() {
    ...
    var We = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        Ce = "Январь_Февраль_Март_Апрель_Май_Июнь_Июль_Август_Сентябрь_Октябрь_Ноябрь_Декабрь".split("_");
    var He = "Янв_Фев_Март_Апр_Май_Июнь_Июль_Авг_Сент_Окт_Ноя_Дек".split("_");
    ...
    var Ze = "Воскресенье_Понедельник_Вторник_Среда_Четверг_Пятница_Суббота".split("_");
    var ze = "Вос_Пон_Вто_Сре_Чет_Пят_Суб".split("_");
    var $e = "Вс_Пн_Вт_Ср_Чт_Пт_Сб".split("_");
    var qe = ae;
    var Je = ae;
    var Be = ae;
